...
function url_replace($url) {
    ...
    $replacementMap = @{
        ...
        # Flutter
        'storage\.googleapis\.com/flutter_infra'                               = 'mirrors.cernet.edu.cn/flutter/flutter_infra'
        'storage\.googleapis\.com/flutter_infra_release'                       = 'mirrors.cernet.edu.cn/flutter/flutter_infra_release'
