...
function Get-ISPName {
    try {
        info '[GetISP] Detecting IP information (API: ipwho.is)...'
        ...
        error '[GetISP] Failed to detect IP information. (API: ipwho.is)'
        debug "$_"
        try {
            info '[GetISP] Detecting IP information (API: ip.sb)...'
            ...
            error '[GetISP] Failed to detect IP information. (API: ip.sb)'
            debug "$_"
            try {
                ...
                error '[GetISP] Failed to detect IP information. (API: realip.cc)'
                debug "$_"
                return 'Unknown'
            }
        }
